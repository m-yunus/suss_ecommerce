...
const Store = () => {
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="lg:w-5/6 mx-auto">
      <div class="ofr flex flex-wrap w-full bg-green-900 py-32 px-10 relative mb-4">
        <img alt="gallery" class="w-full object-cover h-full object-center block opacity-25 absolute inset-0" src=""/>
        <div class="text-center relative z-10 w-full">
          <h2 class="text-2xl text-white font-large title-font mb-2">40% OFF</h2>
